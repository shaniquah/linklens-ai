                ...
                <div class="bg-zinc-300 dark:bg-white overflow-hidden shadow rounded-lg">
                    <div class="p-6">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <button wire:click="toggleAutoAccept" class="toggle-switch {{ $profile->auto_accept_connections ? 'enabled' : 'disabled' }}">
                ...
                <div class="bg-zinc-300 dark:bg-white overflow-hidden shadow rounded-lg">
                    <div class="p-6">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <button wire:click="togglePostAutomation" class="toggle-switch {{ $profile->post_automation_enabled ? 'enabled' : 'disabled' }}">
                                <span class="toggle-thumb"></span>
                            </button>
                        </div>
